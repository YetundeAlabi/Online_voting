...
urlpatterns = [
    ...
    path("polls/<int:pk>/candidates/create", views.CandidateCreateView.as_view(), name="create-candidate"),
    path("polls/<int:pk>/voters/create", views.VoterCreateView.as_view(), name="create-voter"),
    ...
    path('polls/<int:pk>/candidates/', views.CandidateListView.as_view(), name='list-candidate'),
    ...
    path("send-email/<int:pk>", views.SendEmailView.as_view(), name="send-email"),
